"""
Django settings for travel_chatbot_app project.
...
SECRET_KEY = 'django-insecure-4s&b%l0+=j6b8*0$xm(k2wk7^scwg3hil7jwc8chyovd6ru!o5'
...
ROOT_URLCONF = 'travel_chatbot_app.urls'
